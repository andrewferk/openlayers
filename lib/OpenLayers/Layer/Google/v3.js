...
OpenLayers.Layer.Google.v3 = {
    ...
    loadMapObject:function() {
        ...
        this.bindObject = new google.maps.MVCObject();
        this.bindObject.bindTo("center", this.mapObject);
        this.bindObject.bindTo("zoom", this.mapObject);
  ...
  // LonLat - Pixel Translation
    ...
    setMapObjectCenter: function(center, zoom) {
        ...
        this.bindObject.set("center", center);
        this.bindObject.set("zoom", zoom);
    },
